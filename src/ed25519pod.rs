...
pub mod tests {
    ...
    fn test_ed25519_pod_with_mainpod_verify() -> Result<()> {
        ...
        let (ed25519_pod, params, vdset) = compute_new_ed25519_pod(namespace, msg, &sig)?;
        ...
        // add operation that ensures that the msg is as expected in the Ed25519Pod
    ...
    fn test_serialization() -> Result<()> {
        ...
        let recovered_ed25519_pod =
            Ed25519Pod::deserialize_data(params, data, vdset.root(), ed25519_pod.id).unwrap();
        let recovered_ed25519_pod = (recovered_ed25519_pod as Box<dyn Any>)
            .downcast::<Ed25519Pod>()
            .unwrap();
